...
# collects accession numbers from a blast results XML that are within a specified expectation value
...
for record in NCBIXML.parse(open('')):
...
with open('complete_neighborhood_results.tsv', 'w') as output_file:
